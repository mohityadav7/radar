$(document).ready(function () {
    ...
    $("#form1").submit(function (event) {
        ...
        if (formData[0].value != '') {
            ...
            if (formData[3].value != '') {
                ...
                getTwitterDataForTwo(formData[1].value, formData[4].value);
            }
            else {
                // show results for one business
                console.log('first one');
                getInstaData(formData[1].value);
                getTwitterData(formData[1].value);
            }
        }
        else {
    ...
    function getTwitterData(twitter_username) {
        $.ajax({
            url: "http://insta-twi.herokuapp.com/insta/",
            method: "POST",
            data: { insta_user_name: twitter_username }
        }).done(function (data) {
    ...
    function getTwitterDataForTwo(twitter_username, twitter_username2) {
        $.ajax({
            ...
            $.ajax({
                url: "http://insta-twi.herokuapp.com/insta/",
                method: "POST",
                data: { insta_user_name: twitter_username2 }
            }).done(function (data2) {
